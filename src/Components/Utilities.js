export function translate(cardData, sourceLanguage, targetLanguage) {
  //   cardData = JSON.parse(cardData);
  // const sourceLanguage = cardJson["sourceLanguage"];
  // const targetLanguage = cardJson["targetLanguage"];
  console.log("cardJson ", cardData);
  ...
  const myJson = {
    ...
    fetch(apiUrlConfig, requestOptionsConfig)
      ...
      // localStorage.setItem("translatedData", JSON.stringify(translatedJson));
  }